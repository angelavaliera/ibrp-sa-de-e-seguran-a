    ...
    <div className="min-h-screen" style={{ background: "hsl(18, 40%, 95%)" }}>
      ...
      <section className="relative pt-28 pb-20 md:pt-36 md:pb-28 overflow-hidden">
        <div className="absolute inset-0">
          <img src={terapeutasHeroBg} alt="Profissionais meditando em ambiente corporativo no curso Terapeutas Integrativos riscos psicossociais NR-1 do Instituto Brasileiro de Riscos Psicossociais - IBRP" className="w-full h-full object-cover" /> alt="Profissionais meditando em ambiente corporativo no curso Terapeutas Integrativos riscos psicossociais NR-1 do Instituto Brasileiro de Riscos Psicossociais - IBRP" className="w-full h-full object-cover" /> className="w-full h-full object-cover" />
            ...
            <Accordion type="single" collapsible className="space-y-3">
              {modules.map((mod, i) => (
                ...
                >
                  <AccordionItem
                    value={`mod-${i}`}
                    className="rounded-xl border border-[hsl(18_30%_85%)] px-6"
                    style={{ background: "hsl(18, 30%, 94%)", boxShadow: "var(--shadow-card)" }}
                  >
